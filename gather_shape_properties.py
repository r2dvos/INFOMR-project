...
def shape_properties(shape: trimesh.Trimesh, obj_path: str):
    ...
    data_dict = dict(A3 = data_A3,
                     ...
                     D3 = data_D3,
                     D4 = data_D4)
    return ((area, compactness, regularity, diameter, convexity, eccencitry, new_hist_A3, bins_A3, new_hist_D1, bins_D1, new_hist_D2, bins_D2, new_hist_D3, bins_D3, new_hist_D4, bins_D4), data_dict)
    ...
    for root, _, files in os.walk(db_path):
        for file in files:
            if file.endswith('.obj'):
                ...
                properties = shape_properties(shape, obj_path)
